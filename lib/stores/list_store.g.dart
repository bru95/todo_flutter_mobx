...
mixin _$ListStore on _ListStore, Store {
  Computed<bool> _$isNewTodoValidComputed;

  @override
  bool get isNewTodoValid =>
      (_$isNewTodoValidComputed ??= Computed<bool>(() => super.isNewTodoValid,
              name: '_ListStore.isNewTodoValid'))
          .value;
